...
export const EFFECTS: EffectMeta[] = [
	...
	{ id: 'ember', label: 'Embers', icon: 'fa-fire', particles: false },
	{ id: 'confetti', label: 'Confetti', icon: 'fa-star', particles: false },
	{ id: 'bubbles', label: 'Bubbles', icon: 'fa-circle', particles: false },
