...
>
	...
	>
		...
		<div
			class="border-base-300 relative z-2 overflow-hidden rounded-[20px] border bg-linear-[165deg] from-white/97 to-[#f2f0ef]/95 shadow-[0_8px_40px_rgba(26,52,63,0.14)]"
			bind:this={cardEl}
		>
			<div class="pointer-events-none absolute inset-0 overflow-hidden">
				<div
					class="absolute -top-[40%] -left-[20%] h-[80%] w-[140%] rounded-full opacity-8 blur-[40px]"
					style="background: linear-gradient(135deg, {accentColor}, #245f73);"
				></div>
			</div>
			...
			<div class="relative px-5.5 pt-5 pb-4">
				...
				<div class="flex flex-col items-center text-center">
					<div class="mb-3.5">
						<div
							class="rounded-full p-1 shadow-[0_4px_20px_rgba(36,95,115,0.18)]"
							style="background: conic-gradient(from 220deg, {accentColor}, var(--color-primary), #5a9eb4, {accentColor});"
						>
							<img
