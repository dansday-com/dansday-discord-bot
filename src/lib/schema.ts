...
export const botRobloxItems = mysqlTable(
	'bot_roblox_items',
	{
		...
		lowest_resale_price: bigint('lowest_resale_price', { mode: 'number' }),
		total_quantity: bigint('total_quantity', { mode: 'number' }),
		favorite_count: int('favorite_count'),
		units_available: bigint('units_available', { mode: 'number' }),
		thumbnail_url: varchar('thumbnail_url', { length: 512 }),
		item_created_at: datetime('item_created_at'),
		last_price: bigint('last_price', { mode: 'number' }),
		last_lowest_resale_price: bigint('last_lowest_resale_price', { mode: 'number' }),
		last_total_quantity: bigint('last_total_quantity', { mode: 'number' }),
		last_units_available: bigint('last_units_available', { mode: 'number' }),
		created_at: datetime('created_at').notNull()
	},
