...
<div class="bg-ash-950 text-ash-100 flex min-h-screen flex-col">
	<header class="bg-ash-800 border-ash-700 sticky top-0 z-40 shrink-0 border-b">
		<div class="mx-auto flex h-14 w-full max-w-7xl items-center justify-between gap-3 px-3 lg:h-16 lg:px-8">
			<a href={DASHBOARD_PATH} class="flex min-w-0 flex-1 items-center gap-2 lg:gap-3">
				<div class="bg-ash-400 flex h-8 w-8 shrink-0 items-center justify-center rounded-full lg:h-10 lg:w-10">
					<i class="fas fa-bolt text-ash-100 text-base lg:text-base"></i>
				</div>
