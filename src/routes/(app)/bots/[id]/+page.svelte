...
<div class="mx-auto max-w-7xl px-3 py-4 sm:px-4 sm:py-6 lg:px-8 lg:py-8">
	...
	<div class="bg-ash-800 border-ash-700 mb-4 rounded-xl border p-4 sm:mb-6 sm:p-6">
		...
		<label class="border-ash-600 bg-ash-700 mb-4 flex cursor-pointer items-center justify-between rounded-lg border px-3 py-2">
			<span class="text-ash-200 text-sm font-medium">Enable AI chat</span>
			<input type="checkbox" bind:checked={ai.enabled} class="h-4 w-4 accent-violet-600" />
		</label>
