...
<div class="mx-auto max-w-7xl px-3 py-4 lg:px-8 lg:py-8">
	...
	<div class="bg-ash-800 border-ash-700 mb-4 rounded-xl border p-4 lg:mb-6 lg:p-6">
		...
		<div class="mt-6 flex flex-col gap-3 lg:flex-row lg:flex-wrap *:lg:flex-1 *:lg:basis-0">
			...
			{#if data.bot.port}
				<div class="bg-ash-700 rounded-lg p-3">
					<p class="text-ash-400 mb-1 text-base">Port</p>
					<p class="text-ash-100 text-base font-medium">{data.bot.port}</p>
				</div>
			{/if}
		</div>
	</div>
		...
		<div class="flex flex-col gap-4 lg:flex-row lg:flex-wrap *:lg:flex-1 *:lg:basis-0">
			...
			{#if presence.activity_type === 'custom'}
				<div class="lg:col-span-2">
					<label for="presence-activity-state" class="text-ash-400 mb-1 block text-base">Custom status</label>
					<input
						...
						class="bg-ash-700 border-ash-600 text-ash-100 placeholder:text-ash-500 w-full rounded-lg border px-3 py-2 text-base focus:ring-2 focus:ring-violet-500 focus:outline-none"
					/>
				</div>
			{:else}
				<div class="lg:col-span-2">
					<label for="presence-activity-name" class="text-ash-400 mb-1 block text-base">Activity name</label>
					<input
				...
				{#if presence.activity_type === 'streaming'}
					<div class="lg:col-span-2">
						<label for="presence-activity-url" class="text-ash-400 mb-1 block text-base">Stream URL</label>
				...
				{/if}
				<div class="lg:col-span-2">
					<label for="presence-activity-state-noncustom" class="text-ash-400 mb-1 block text-base">State</label>
					<input
		...
		{:else}
			...
			{#if totalPages > 1}
				<div class="flex items-center justify-between">
					...
					>
						<i class="fas fa-chevron-left text-base"></i>Previous
					</button>
					...
					<button
						...
						class="bg-ash-700 hover:bg-ash-600 text-ash-200 flex items-center gap-2 rounded-lg px-3 py-1.5 text-base transition-colors disabled:cursor-not-allowed disabled:opacity-40"
					>
						Next<i class="fas fa-chevron-right text-base"></i>
					</button>
				</div>
			{/if}
		{/if}
