...
<div class="bg-ash-800 border-ash-700 space-y-5 rounded-xl border p-4 sm:p-6">
	...
	<p class="text-ash-400 text-xs">
		Boosters can create their own coloured role. The bot places it directly above the Server Booster role, so it shows as their colour.
	</p>
	...
	{#if featureEnabled}
		<p class="flex items-start gap-2 text-xs text-amber-200/90">
			<i class="fas fa-circle-info mt-0.5 shrink-0 text-amber-400/90" aria-hidden="true"></i>
			<span>The bot's own role must sit above the Server Booster role. The Server Booster role appears once someone boosts the server.</span>
		</p>
	{:else}
		<p class="flex items-start gap-2 text-xs text-amber-200/90">
