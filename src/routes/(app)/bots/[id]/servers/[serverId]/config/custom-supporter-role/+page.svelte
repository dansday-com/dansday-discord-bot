...
<div class="bg-ash-800 border-ash-700 space-y-5 rounded-xl border p-4 lg:p-6">
	...
	<p class="text-ash-400 text-base">Define the role range where custom supporter roles will be created.</p>
	...
	<div class="space-y-5 transition-opacity" class:pointer-events-none={!featureEnabled} class:opacity-50={!featureEnabled}>
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">Highest role position where custom supporter roles will be created. Roles will be placed below this.</p>
		...
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">Lowest role position where custom supporter roles will be created. Roles will be placed above this.</p>
