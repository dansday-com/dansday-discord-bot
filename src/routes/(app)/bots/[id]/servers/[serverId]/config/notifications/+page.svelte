...
<div class="bg-ash-800 border-ash-700 space-y-5 rounded-xl border p-4 lg:p-6">
	...
	<p class="text-ash-400 text-base">Per-channel notification opt-in for members (bot menu) from selected categories. Not Discord Quest alerts.</p>
	...
	<div class="space-y-5 transition-opacity" class:pointer-events-none={!featureEnabled} class:opacity-50={!featureEnabled}>
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">These channels will be available for members to opt-in for notifications. Multiple channels allowed.</p>
