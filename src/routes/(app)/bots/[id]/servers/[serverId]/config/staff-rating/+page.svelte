...
<div class="bg-ash-800 border-ash-700 space-y-5 rounded-xl border p-4 lg:p-6">
	...
	<p class="text-ash-400 text-base">Review queue, rating announcements, cooldown, and rating-role placement.</p>

	<ConfigToggleRow
		label="Staff rating module"
		description="When off, staff rating flows and related Discord UI are disabled."
		labelIconClass="fas fa-clipboard-check text-orange-400"
	...
	<div class="space-y-5 transition-opacity" class:pointer-events-none={!featureEnabled} class:opacity-50={!featureEnabled}>
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">The highest boundary role. Rating roles will be created/updated <strong>below</strong> this.</p>
		...
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">The lowest boundary role. Rating roles will be created/updated <strong>above</strong> this.</p>
		...
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">Where submissions go for staff review.</p>
		...
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">Where rating updates/announcements are sent.</p>
		...
		<div>
			...
			<p class="text-ash-500 mb-2 text-base">Role to mention on pending submissions. Optional.</p>
