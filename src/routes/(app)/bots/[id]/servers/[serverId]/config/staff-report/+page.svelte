...
<div class="bg-ash-800 border-ash-700 space-y-5 rounded-xl border p-4 sm:p-6">
	...
	<div class="flex items-center justify-between">
		<label class="text-ash-300 text-xs font-medium">Enable Staff Report & Rating</label>
	...
	<div>
		<label class="text-ash-300 mb-1.5 block text-xs font-medium">Report Channel</label>
