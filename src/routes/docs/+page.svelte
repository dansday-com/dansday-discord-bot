<script lang="ts">
	...
	import FieldList from '$lib/frontend/components/FieldList.svelte';
	import StepList from '$lib/frontend/components/StepList.svelte';
		...
		<div class="relative z-1 mx-auto w-full max-w-7xl px-4 pt-4 pb-12 lg:px-8">
			<div class="flex flex-col gap-10 pt-2 pb-12">
				<header class="g-hero pt-4 text-center" use:reveal>
					...
					<Button href={officialBotInviteUrl} variant="primary" class="mt-5" target="_blank" rel="noopener noreferrer">
						<i class="fab fa-discord"></i>
						Add the bot to start
					</Button>
				</header>

				<nav class="m-0 mb-7 flex flex-wrap justify-center gap-2" aria-label="Sections">
					{#each sections as s}
						<a
							href="#{s.id}"
				...
				<section id="start" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-flag-checkered"></i>Get started</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">Three steps take you from nothing to a configurable server.</p>
					<StepList steps={startSteps} />
				</section>

				<section id="bots" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-robot"></i>Official bot vs selfbot</h2>
				...
				<section id="setup-command" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-terminal"></i>The /setup command</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
					...
					<FieldList fields={setupChannels.map((x) => ({ label: x.name, desc: x.desc }))} />
				</section>

				<section id="accounts" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-user-plus"></i>Accounts &amp; staff</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
				...
				<section id="roles" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-users-gear"></i>Who can do what</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
				...
				<section id="permissions" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-user-shield"></i>Permissions</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">Map Discord roles to what they unlock. Set these on the Permissions page.</p>
					<FieldList fields={permissionRoles} />
				</section>

				<section id="modules" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold">
				...
				<section id="shop" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-store"></i>Set up the items shop</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
					...
					<StepList steps={shopSteps} />
				</section>

				<section id="discord" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fab fa-discord"></i>The Discord menu</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
				...
				<section id="selfhost" class="g-sec" use:reveal>
					<h2 class="g-sec-head text-lb-text m-0 mb-2 flex items-center gap-3 text-lg font-extrabold"><i class="fas fa-server"></i>Self-host setup</h2>
					<p class="g-sec-lead text-lb-text-muted m-0 mb-5 text-base">
						The project is open source under MIT. Run your own instance with Node, MySQL and optional Redis.
					</p>
					<StepList steps={selfhostSteps} />
					<h3 class="text-lb-text m-0 mt-6 mb-1 text-base font-extrabold">Environment variables</h3>
